...
public class MySpringbootTest {
    ...
    //使用mock包装的bean，对bean调用的方法进行模拟返回值
    @MockBean
    ...
    public void controllerTest() throws Exception {
        ...
        // 模拟方法调用
        Mockito.doReturn(userVO).when(systemService).getUserInfo(1);
        // 构建请求
    ...
    public void serviceTest() throws Exception {
        ...
        // 模拟方法调用
        Mockito.doReturn(userVO).when(systemService).getUserInfo(1);
        log.info("调用getUserInfo()查询用户信息，模拟返回数据={}", systemService.getUserInfo(1));
    }
