...
public enum PreStatementSqlBuilder {
    ...
    public PreStatementSql buildQuerySql(Long Id, Class<?> clazz) throws Exception {
        PreStatementSql preSql = new PreStatementSql();
        ...
        // 参数
        List<AttributeValue> params = new ArrayList<>();
        params.add(new AttributeValue(Id, "java.lang.Long"));
