...
public class LRUCacheManager {
    ...
    private static LRUCacheManager getCacheManagerInstance() {
        return CacheManagerFactory.CACHE_MANAGER;
    }

    private static class CacheManagerFactory {
        private static final LRUCacheManager CACHE_MANAGER = new LRUCacheManager();
    }
...
//                        Thread.sleep(1000 * 60 * 60);
    ...
    public static void main(String[] args) throws Exception {
        LRUCacheManager cacheManager = LRUCacheManager.getCacheManagerInstance();
        cacheManager.init(0);
