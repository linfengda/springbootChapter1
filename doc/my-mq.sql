...
`send_time` datetime NOT NULL DEFAULT '1970-01-01 08:00:01' COMMENT '最后一次推送时间',
`die_count` int NOT NULL DEFAULT '5' COMMENT '死亡（最大发送）次数',
`error_msg` varchar(255) NOT NULL DEFAULT '' COMMENT '执行错误信息',
`confirm_time` datetime NOT NULL DEFAULT '1970-01-01 08:00:01' COMMENT '发送成功回调时间',
`die_time` datetime NOT NULL DEFAULT '1970-01-01 08:00:01' COMMENT '变更为死亡状态时间',
